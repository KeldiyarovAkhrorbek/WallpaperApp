...
import com.projects.wallpaper20.databinding.FragmentPopularBinding;
...
public class PopularFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        itemViewModelCurated.itemPagedList.observe(requireActivity(), (Observer<PagedList<Photo>>) items -> photoAdapter.submitList(items));
